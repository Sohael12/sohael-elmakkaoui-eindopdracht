        ...
        <div className="bg-gradient-to-b from-[#0F0F0F] to-[#1a1a2e] text-white min-h-screen">
            ...
            <div className="container mx-auto px-4 sm:px-6 py-16 relative z-10">
                ...
                <motion.div initial={{opacity: 0}} animate={{opacity: 1}} transition={{duration: 0.6}}>
                            ...
                            <div className="flex flex-col lg:flex-row">
                                ...
                                >
                                    <div className="relative group max-w-[350px]">
                                        <div
                                            className="absolute -inset-1 bg-gradient-to-r from-yellow-600 to-purple-600 rounded-lg blur opacity-25 group-hover:opacity-70 transition duration-1000"></div>
                                        <div className="relative">
                                            <Image
                                        ...
                                        >
                                            {manga.score && (
                                                <Badge variant="outline"
                                                       className="bg-blue-900/30 border-blue-700 text-blue-400 px-3 py-1">
                                                    <Star className="w-4 h-4 mr-1 inline"
                                                          fill="currentColor"/> {manga.score}
                                                </Badge>
                                            )}
                                            ...
                                            {manga.chapters && (
                                                ...
                                                >
                                                    <BookOpen
                                                        className="w-4 h-4 mr-1 inline"/> {manga.chapters} Chapters
                                                </Badge>
                                            )}
                                        </motion.div>
                                        ...
                                        >
                                            <Tabs defaultValue="overview" className="w-full"
                                                    ...
                                                    <div className="space-y-4">
                                                        ...
                                                        <div className="grid gap-3">
                                                            {chapters.length > 0 ? (
                                                                ...
                                                                <div
                                                                    className="text-center py-8 bg-gray-800/30 rounded-lg border border-gray-700">
                                                                    <BookMarked
                                                                        className="mx-auto h-12 w-12 text-gray-500 mb-2"/>
                                                                    <p className="text-gray-400">No chapters
                                                                        available</p>
                                                                </div>
                                                            )}
                                                        </div>
                                                ...
                                                <TabsContent value="details" className="mt-6">
                                                    <div className="space-y-6">
                                                        <h3 className="text-xl font-semibold text-gray-200">Additional
                                                            Information</h3>
                                                            ...
                                                            {manga.scored_by && (
                                                                <div
                                                                    ...
                                                                    <div className="flex items-center gap-2">
                                                                        ...
                                                                        <p className="text-sm text-gray-400">Scored
                                                                            By</p>
                                                                    </div>
                    ...
                    >
                        <div
                            className="bg-gray-900/60 backdrop-blur-sm rounded-xl p-6 border border-gray-800 max-w-2xl mx-auto">
                            ...
                            <div className="flex flex-wrap justify-center gap-4">
                                ...
                                >
                                    <a
                                        href="https://globalcomix.com/browse/manga"
                                        target="_blank"
